...
export interface IDrawingClient {
  ...
  /** Prepare drawing objects. */
  prepareDrawings2(data: DrawingData): IDrawingObject[];
}
...
export class XDrawingClient implements IDrawingClient {
 ...
 //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): IDrawingObject[] {
    return [];
  }
...
export class AnsDrawingClient extends XDrawingClient {
  ...
  //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): AnsDrawingObject[] {
...
export class BeatsDrawingClient extends XDrawingClient {
  ...
  //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): BeatsDrawingObject[] {
    console.info("prepareDrawings2", "not implemented");
    return [];
  }
...
export class GridCellDrawingClient extends XDrawingClient {
  ...
  //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): GridCellDrawingObject[] {
    console.info("prepareDrawings2", "not implemented");
    return [];
  }
...
export class SignalDrawingClient extends XDrawingClient {
  ...
  //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): SignalDrawingObject[] {
    console.info("prepareDrawings2", "not implemented");
    return [];
  }
...
export class FPointDrawingClient extends XDrawingClient {
  ...
  //-------------------------------------------------------------------------------------
  public prepareDrawings2(data: DrawingData): FPointDrawingObject[] {
    console.info("prepareDrawings2", "not implemented");
    return [];
  }
}
